...
export async function createDealerShift(
  prevState: DealerShiftState,
  formData: FormData
): Promise<DealerShiftState> {
  ...
  if (
    !ringGameTypeStr ||
    !Object.values(RingGameType).includes(ringGameTypeStr as RingGameType)
  ) {
...
export async function updateDealerShift(
  id: string,
  prevState: DealerShiftState,
  formData: FormData
): Promise<DealerShiftState> {
