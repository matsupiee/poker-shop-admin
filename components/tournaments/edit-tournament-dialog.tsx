    ...
    <Drawer open={open} onOpenChange={setOpen} direction="right">
      ...
      <DrawerContent className="h-full sm:max-w-[760px] flex flex-col">
        <DrawerHeader className="flex-none border-b">
          ...
          <DrawerDescription>トーナメント情報を編集します。</DrawerDescription>
        </DrawerHeader>
...
function EditTournamentForm({
  ...
  useEffect(() => {
    ...
    if (tournament.tournamentPrizes && tournament.tournamentPrizes.length > 0) {
      setPrizes(
        tournament.tournamentPrizes.map((p: any) => ({
          rank: p.rank,
          amount: p.amount,
        }))
      );
    ...
    if (
      tournament.tournamentChipEventOptions &&
      tournament.tournamentChipEventOptions.length > 0
    ) {
      setChipEventOptions(
        tournament.tournamentChipEventOptions.map((o: any) => ({
  ...
  const defaultEventDate =
    ...
    "-" +
    (startAtDate.getMonth() + 1).toString().padStart(2, "0") +
    "-" +
    startAtDate.getDate().toString().padStart(2, "0");
                ...
                <div className="grid grid-cols-4 items-center gap-4">
                  ...
                  <div className="col-span-3">
                    <Input
                      ...
                      min="1"
                      defaultValue={
                        tournament.tournamentBounty?.ticketCount ?? 1
                      }
                    />
                  </div>
                </div>
                <div className="grid grid-cols-4 items-center gap-4">
                  ...
                  <div className="col-span-3 pb-2 relative">
                    ...
                    <Input
                      ...
                      placeholder="0"
                      defaultValue={
                        tournament.tournamentBounty?.totalAmount ?? 0
                      }
                    />
                  </div>
                </div>
