...
export function RegisterVisitDialog({ player, open, onOpenChange }: RegisterVisitDialogProps) {
    const [state, action, isPending] = useActionState(registerVisit, initialState)
